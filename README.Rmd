...
[![CRAN status](https://www.r-pkg.org/badges/version/gradR)](https://CRAN.R-project.org/package=gradR)
...
You can install the development version of gradR from [GitHub](https://github.com/) with:
